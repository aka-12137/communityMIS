...
<div class="container clearfix">
                ...
                <div class="result-title">
                    <div class="result-list">
                        ...
                        <font style="background: none;border: 0;color: red;font-weight: 900;font-size: 24px;"><s:actionmessage /></font>
                                    	...
                                    	name="member.name" size="50" value="吴燕" type="text"/>
    ...
    border: 1px solid #aeaeae;border-radius: 5px;" value="查询" type="button" onclick="location.href='spe_member.jsp'" />
                ...
                <div class="result-content">
                        ...
                        <tr>
							...
							<tr>
								...
								<td style="text-align: center;">
										...
										<a href="user_member_edit.action?member.id=5"
											class="tablelink">修改</a>&nbsp;&nbsp;
										<a href="user_member_del.action?member.id=5"
					...
					<div class="message">
						共
						<i class="blue">1</i>条记录，当前显示第&nbsp;
						<i class="blue">1&nbsp;/&nbsp;1&nbsp;</i>页
					</div>
					<ul class="paginList">
						<li class="paginItem">
							<a
